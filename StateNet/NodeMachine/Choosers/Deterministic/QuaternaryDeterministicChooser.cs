...
namespace Aptacode.StateNet.NodeMachine.Choosers.Deterministic
{
    ...
    {
        public QuaternaryDeterministicChooser(Node option1, Node option2, Node option3, Node option4) : base(new QuaternaryOptions(option1, option2, option3, option4), QuaternaryChoice.Item1) { }
    }
}
