...
{
    public class TernaryProbabilityChooser : ProbabilityChooser<TernaryChoice>
    {
        public TernaryProbabilityChooser(int item1Weight, int item2Weight, int item3Weight)
        {
